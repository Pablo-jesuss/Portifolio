...
const Education = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center lg:px-32 px-5 bg-backgroundColor">
      <h1 className=" text-red-600 text-center font-semibold text-6xl mt-24 lg:mt-16 mb-8 lg:mb-7">
        Education
      </h1>

      <div className="bg-black text-white p-9 rounded-md flex flex-col items-center lg:items-stretch font-semibold ">
        <EducationCard
          title="Faculdade"
          state="Formado"
